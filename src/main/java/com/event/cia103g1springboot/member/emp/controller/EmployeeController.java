...
//	 */
//	@PutMapping("/profile")
//	public ResponseEntity<?> updateProfile(@RequestParam("empId") Integer empId,
//			@RequestParam("empName") String empName, @RequestParam("empJobTitle") String empJobTitle,
//			@RequestParam(value = "empImg", required = false) MultipartFile empImg) {
//
//		try {
//			EmployeeVO employee = new EmployeeVO();
