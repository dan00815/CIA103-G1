...
public class FilterConfig {
	...
	public FilterRegistrationBean<LoginFilter> myFilter() {
		...
		registrationBean.addUrlPatterns("/mem/profile","/shop/checkOut", "/shop/get_myPdtOrder", "/roomOrder/historyRO","/confirm/*","/attend/*","/member/notify","/planord/attend/*","/frontOrderDetail"); // 需要過濾的路徑，路徑要對到controller的映射
//		
